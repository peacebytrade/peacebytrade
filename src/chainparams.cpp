...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "2015-02-15 GMT - Boris Johnson to renounce US citizenship";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        genesis.nTime    = 1424004186; //1398645614
        genesis.nBits    = 0x1e0fffff;
        genesis.nNonce   = 4844322;
...
//       */
	...
	assert(hashGenesisBlock == uint256("0x00000754bef57af1a3f6cfbfaa50d23f947a8e926e45cdcde151a20238608ab3"));
        assert(genesis.hashMerkleRoot == uint256("0x85d4c9204a200845e35d8e5f94d57447de14708943bb1c3fedc760dd7ed54294"));

        vSeeds.push_back(CDNSSeedData("peacebytrade.com", "peacebytrade.com"));
        vSeeds.push_back(CDNSSeedData("91.121.135.59", "91.121.135.59"));


        base58Prefixes[PUBKEY_ADDRESS] = 55; //peacebytrade address starts with P
...
public:
    CTestNetParams() {
        ...
        genesis.nTime = 1424004186; //1392876393
        genesis.nNonce = 4844322;
...
//
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("testseed1.peacebytrade.org", "testseed1.peacebytrade.org"));
...
public:
    CRegTestParams() {
        ...
        genesis.nTime = 1424004186; //1296688602
...
bool SelectParamPBTomCommandLine() {
